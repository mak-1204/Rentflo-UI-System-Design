...
function OwnerWebsiteBuilderComponent() {
  ...
  const [depositAmount, setDepositAmount] = useState('Γé╣10,000 (1 Month Rent)');
  ...
  // Cycle toggle fixture (None Γ₧ö Door Γ₧ö Window)
                  ...
                  {selectedRoom ? (
                    <div className="space-y-4 text-xs">
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            title="Rotate 90┬░ ΓÇö swaps width and height"
                          >
                          ...
                          <div>
                            ...
                            <div className="relative rounded-md shadow-sm">
                              <div className="absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none">
                                <span className="text-slate-500 text-[10px]">Γé╣</span>
                              </div>
                              <Input
                                type="number"
                      ...
                      <div className="space-y-2 border-t border-slate-100 pt-3">
                        ...
                        <p className="text-[10px] text-slate-450 leading-tight">Click on any wall to cycle: None Γ₧ö Door Γ₧ö Window</p>
          ...
          <TabsContent value="food" className="space-y-6 mt-6">
            <Card className="p-8 bg-white border border-[#E5E7EB] shadow-sm rounded-2xl space-y-6">
              ...
              <div className="p-4 bg-teal-50/50 border border-teal-100 rounded-xl text-teal-900 space-y-1">
                <p className="text-xs font-bold font-heading">≡ƒÆí StayFlo Food Tech Feature</p>
