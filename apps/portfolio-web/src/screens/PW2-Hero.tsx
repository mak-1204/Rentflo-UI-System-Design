import { useState, useEffect } from 'react'; import { useRouter } from 'next/navigation'; import { Star, MapPin, Wifi, Shield, Coffee, Compass, Check, ArrowRight, PhoneCall, CalendarCheck, X } from 'lucide-react'; import { Button } from '@rentflo/ui';
...
export function PortfolioHero() {
  ...
  const [showLeadPopup, setShowLeadPopup] = useState(() => {
    if (typeof window !== 'undefined') {
      return !localStorage.getItem('rentflo_lead_submitted');
    }
    return true;
  });
  ...
  const handleLeadSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (typeof window !== 'undefined') {
      localStorage.setItem('rentflo_lead_submitted', 'true');
    }
    try {
